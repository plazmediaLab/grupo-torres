...
export default function CardImageMain() {
  return (
    <div className="relative">
      <div className="image-last-property h-40 relative">
        ...
        <p className="absolute py-2 pr-3 pl-2 bg-blue-gray-900 bg-opacity-70 bottom-0 left-0 text-yellow-500">
          <svg
